...
**Soul-spend menu — ✅ Finalized August 15, 2026, ❌ Not built:** 8 options, offer 3 at random per spend window. Built around tradeoffs (stronger effects cost more or carry a downside) with two dice-native options rather than pure stat boosts throughout.
...
| Item | Priority | Notes |
|---|---|---|
| Soul in-run stat menu | Low | ✅ Design finalized Aug 15, 2026 — see Soul/Core/Challenge section. Only build work remains, not design. |
...
| Soul in-run stat-upgrade screen | UI + logic for the 8-option menu (finalized Aug 15, 2026 — see Soul/Core/Challenge section); offer-3-of-8 random selection logic, cost tracking, rebuy pricing for Vitality |
